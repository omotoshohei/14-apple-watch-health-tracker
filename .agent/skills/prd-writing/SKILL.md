...
プロダクトのアイデアについて、ユーザー自身がAntigravityとの対話を通じてブラッシュアップを完了している必要があります。
...
`view_file` ツールを用いて、該当ファイルを読み込みます:
```
view_file('docs/ideas/initial-requirements.md')
```
